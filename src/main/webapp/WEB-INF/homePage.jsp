	...
	<nav class="navbar navbar-expand-lg fixed-top navbar-light bg-light">
		<div class="container">
			...
			<div class="dropdown">
				...
				<img class="icon" src=<c:out value="${currentUser.profilePicture}"/>>
				</a>
			   			...
			   			<div class="card mt-3">
			   				<div class="card-body">
				   				<div class="row">
							   		...
							   		<div class="col">@<c:out value="${post.poster.username}"/> - <fmt:formatDate pattern="MMM, dd" value="${post.poster.createdAt}"/></div>
						   		</div>
